...
export default function About() {
  ...
  return (
    <main className="bg-[#F7F9FB] font-sans text-[#2E3B4E]">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-[#1B263B] via-[#2E3B4E]/80 to-[#1B263B] text-white py-24">
      ...
      <section className="bg-[#F7F9FB] py-20 border-t border-[#D4AF37]/20">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[#1B263B] mb-12">
            Our Core Principles
          </h2>
